 ...
 * @author User
 */
public class Admin_Check_And_Send_Confirmation_Message_of_PaymentController implements Initializable {
    ...
    private void sendBtnOnClick(ActionEvent event) throws IOException {
        Parent scene2Parent = FXMLLoader.load(getClass().getResource("Admin_Confirmation_Of_Payment_Message.fxml"));
         Scene scene2 = new Scene(scene2Parent);
         Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
