 ...
 * @author User
 */
public class Care_View_And_Send_MessageController implements Initializable {
    ...
    private void sendBtnOnClick(ActionEvent event) throws IOException {
         Parent scene2Parent = FXMLLoader.load(getClass().getResource("Care_Message_Sending_Confirmation.fxml"));
         Scene scene2 = new Scene(scene2Parent);
         Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
