 ...
 * @author User
 */
public class Admin_Update_Park_InformationController implements Initializable {
    ...
    private void saveBtnOnClick(ActionEvent event) throws IOException {
         Parent scene2Parent = FXMLLoader.load(getClass().getResource("Admin_Park_Information_Update_Confirmation.fxml"));
         Scene scene2 = new Scene(scene2Parent);
         Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
